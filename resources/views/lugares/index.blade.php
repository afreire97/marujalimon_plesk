<x-layout>
    <div class="mode-container" style="display: flex; align-items: center; justify-content: space-between; background-color: #008080; padding: 10px; border-radius: 5px; width: 100%;">
        ...
        <div class="button-container d-flex justify-content-end align-items-center">
            <div class="container d-flex justify-content-end">
                <div class="row">
                    <div class="col">
                        <a href="#modal-dialog-tarea" class="btn btn-warning" id="tareaButton" data-bs-toggle="modal">Asignar coordinador/es a un lugar</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="pagination" class="pagination-controls">
        <button id="prevPage" class="btn btn-outline-primary">&laquo; Anterior</button>
        <span id="pageInfo"></span>
        <button id="nextPage" class="btn btn-outline-primary">Siguiente &raquo;</button>
    </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #008080; display: flex; justify-content: center; align-items: center;">
                    <h4 class="modal-title">Asignar coordinador/es a un lugar</h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="btn-añadirTarea" onclick="asignarLugar()">Añadir</button>
                </div>
            </div>
        </div>
    </div>
